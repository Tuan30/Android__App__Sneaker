...
import nhom8.android_coding.sneaker_app.adapter.DonHanadapter;
...
public class XemDonActivity extends AppCompatActivity {
    ...
    private void getOrder() {
        compositeDisposable.add(apiBanHang.xemDonHang(Utils.user_current.getId())
                ...
                .subscribe(
                        donHangModel -> {
                            DonHanadapter donHanadapter = new DonHanadapter(getApplicationContext(), donHangModel.getResult());
                            redonhang.setAdapter(donHanadapter);
                        },
                        throwable -> {
